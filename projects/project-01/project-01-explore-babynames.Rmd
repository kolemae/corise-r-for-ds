...
tbl_names_popular |> 
  ...
  labs(
    ...
    subtitle = 'Emma and Noah were most popular',
...
plot_trends_in_name("Jordan")
plot_trends_in_name("Kelly")
```
...
tbl_names_by_letter |> 
  ...
  labs(
    title = 'Percentage of Births by First Letter',
    subtitle = 'Most AFAB names started with A, Most AMAB started with J',
    x = 'First Letter',
...
plot_trends_in_letter <- function(my_letter) {
  tbl_names_by_letter |> 
    ...
    labs(
      ...
      subtitle = "AFAB led in K names, except for a short period in the 1930s",
      caption = "Source: US Baby Names",
      x = "Year of Birth",
      y = "Percentage of Births"
    ) +
...
tbl_names_by_first_and_last_letter |> 
  ...
  labs(
      title = "Names by First and Last Letter",
      subtitle = "Highest percentage of names start and end with A",
      caption = "Source: US Baby Names",
      x = "First Letter",
      y = "Last Letter"
    ) +
...
tbl_names_vowel_consonant |> 
  ...
  geom_tile(aes(fill = first_last), color = "black") +
  # Facet wrap plot by `sex`
  facet_wrap(~ sex, scales = "free_y") +
  # Add labels (title, subtitle, caption, x, y)
  labs(
      title = "Names by First and Last Letter Type",
      subtitle = "Highest percentage of names start and end with A",
      caption = "Source: US Baby Names",
      x = "Year",
      y = "Percentage of Births"
